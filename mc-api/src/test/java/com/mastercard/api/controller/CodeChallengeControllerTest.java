...
@SpringBootTest(classes= {CodeChallengeController.class, CityCheckerServiceImpl.class, CityCheckerService.class})

public class CodeChallengeControllerTest {

	
	@Autowired
	CodeChallengeController codeChallengeController;
